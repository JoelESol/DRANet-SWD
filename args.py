...
def get_args():
    ...
    parser.add_argument('--manualSeed', type=int, default=5688) #M2U 5688, 292, 3445    M2MM 5688, 9901, 2516   M2SVHN 8797, 8826, 9330
    ...
    parser.add_argument('--style', type=str, default="gram", help="style loss used. Gram or Sliced Wasserstein discrepancy")
